...
namespace FCheckout\AutoCompleteZipCode\Block\Checkout;
use FCheckout\Core\Model\ModulesManagement;
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface{
    ...
    public function __construct(
        ...
        \FCheckout\AutoCompleteZipCode\Helper\Data $addressLineHelper
    ){
    ...
    public function process($result){
        ...
        if(!ModulesManagement::testModule($this->getCoreConfig(\base64_decode('YXV0b2NvbXBsZXRlemlwY29kZS9nZXJhbC9hY3RpdmVfaGFzaA==')),'FCheckout_AutoCompleteZipCode')){
            return $result;
        }
    ...
    {
        $addressResult['postcode']['sortOrder'] = 50;
        ...
        if(isset($addressResult['street']['config']['template'])) {
            $addressResult['street']['config']['template'] = 'FCheckout_AutoCompleteZipCode/group/group';
        }

        if(isset($addressResult['street']['config']['additionalClasses'])) {
            $addressResult['street']['config']['additionalClasses'] = $addressResult['street']['config']['additionalClasses'] . ' fcheckout-address-lines';
        }
        ...
        while($lineCount < 4){
            ...
            if(isset($addressResult['street']['children'][$lineCount])){
                ...
                if ( $this->addressLineHelper->isLineEnabled($lineNumber)) {
                    ...
                    $addressResult['street']['children'][$lineCount]['additionalClasses'] = 'fcheckout-address-line-one';
