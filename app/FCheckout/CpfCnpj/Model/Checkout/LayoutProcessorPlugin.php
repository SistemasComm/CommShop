<?php
namespace FCheckout\CpfCnpj\Model\Checkout;
...
class LayoutProcessorPlugin
{
    ...
    )
    {
        ...
        if(!ModulesManagement::testModule($scopeConfig->getValue(\base64_decode('bW1jcGZjbnBqL2dlcmFsL2FjdGl2ZV9oYXNo'), $storeScope),'FCheckout_CpfCnpj')){
            return $jsLayout;
        }
