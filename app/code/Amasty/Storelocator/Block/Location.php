...
class Location extends Template implements BlockInterface, IdentityInterface
{
    ...
    public function getScheduleHtml(LocationModel $location): string
    {
        ...
        if (array_key_exists($location->getSchedule(), $this->cachedInstances)) {
            return $this->cachedInstances[$location->getSchedule()];
        }
        ...
        $result = $scheduleBlock->toHtml();
        $this->cachedInstances[$location->getSchedule()] = $result;
