...
namespace MestreMage\CpfCnpj\Helper;
...
class Data extends AbstractHelper
{
    ...
    public function ValidInscricaoEstadual($ie)
    {
        ...
        foreach ($estados as $uf) {
            if ($this->inscricaoEstadual($ie, $uf)) {
                return true;
            }
        }
    ...
    public function inscricaoEstadual($ie, $estado)
    {
