...
class LayoutProcessor
{
    ...
    public function afterProcess($subject, $jsLayout)
    {
        ...
        $required_register = floatval($this->scopeConfigInterface->getValue('opcmestremage/general/required_register', ScopeInterface::SCOPE_STORES));
            ...
            if (isset($jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']['payment']['children'])) {
                ...
                if (!$objectManager->create('Magento\Customer\Model\Session')->isLoggedIn()) {
                    ...
                    $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['code-password'] = [
                        ...
                        'sortOrder' => 0,
                        'validation' => ['required-entry' => ($required_register ? true : false)]
                    ];
