...
use MestreMage\SigepWeb\PhpSigep\Pdf\Script\BarCode128;
...
//            }
    ...
    {
        $this->pdf = new ImprovedFPDF('P', 'mm', array(100, 140));
    ...
    private function writeRemetente($l, $t, $w, Remetente $remetente)
    {
        $titulo = 'Remetente';
