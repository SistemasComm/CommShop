...
use MestreMage\SigepWeb\PhpSigep\PhpSigepFpdfMaster\PhpSigepFPDF;
...
class ImprovedFPDF extends PhpSigepFPDF
{
    ...
    function __construct($orientation = 'P', $unit = 'mm', $size = 'A4')
    {
        ...
        if (!$existed) {
    	    stream_wrapper_register("var", '\MestreMage\SigepWeb\PhpSigep\Pdf\VariableStream') or die("Failed to register protocol");
...
//            return iconv('UTF-8', 'ISO-8859-1', utf8_encode($str));
        } else {
            return utf8_decode($str);
        }
    }
