...
use MestreMage\SigepWeb\PhpSigep\Pdf\Script\Elipse;
...
class Sedex2016 extends AbstractChancela
{
     ...
     */
    public function __construct($x, $y, $nomeRemetente, $tipoServico, AccessData $accessData)
    {
    ...
    public function draw(ImprovedFPDF $pdf)
    {
        ...
        $pdf->Image($_SERVER['DOCUMENT_ROOT'].'/static/frontend/Magento/luma/pt_BR/MestreMage_SigepWeb/images/correios-logo.png', $x1 + 9 , $y1 - 3);
