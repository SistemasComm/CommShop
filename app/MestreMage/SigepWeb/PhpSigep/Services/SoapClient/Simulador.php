<?php
namespace MestreMage\SigepWeb\PhpSigep\Services\SoapClient;
...
class Simulador 
{
     ...
     * @return bool
     */
    public function verificaDisponibilidadeServico(\MestreMage\SigepWeb\PhpSigep\Model\VerificaDisponibilidadeServico $params)
    {
        return true;
    }
     ...
     * @return Etiqueta[]
     */
    public function solicitaEtiquetas(\MestreMage\SigepWeb\PhpSigep\Model\SolicitaEtiquetas $params)
    {
     ...
     * @return Etiqueta[]
     */
    public function geraDigitoVerificadorEtiquetas(\MestreMage\SigepWeb\PhpSigep\Model\GeraDigitoVerificadorEtiquetas $params)
    {
    ...
    public function fechaPlpVariosServicos(\MestreMage\SigepWeb\PhpSigep\Model\PreListaDePostagem $params, \XMLWriter $xmlDaPreLista)
    {
        return time();
    }
     ...
     */
    public function calcPrecoPrazo(\MestreMage\SigepWeb\PhpSigep\Model\CalcPrecoPrazo $params)
    {
        $retorno  = array();
        ...
        foreach ($servicos as $servico) {
            ...
            $item      = new \MestreMage\SigepWeb\PhpSigep\Model\CalcPrecoPrazoResposta(array(
                                                                        'servico'               => $servico,
                                                                        'valor'                 => $total,
        ...
        return new \MestreMage\SigepWeb\PhpSigep\Model\CalcPrecoPrazoRespostaIterator($retorno);
    }
     ...
     * @return mixed
     */
    public function buscaCliente(\MestreMage\SigepWeb\PhpSigep\Model\AccessData $params)
    {
        return new \stdClass();
    }
