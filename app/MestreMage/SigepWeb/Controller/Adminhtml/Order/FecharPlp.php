 ...
 */
class FecharPlp extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction {
    /**
    ...
    protected function massAction( AbstractCollection $collection )
    {
        ...
        return $this->resultRedirectFactory->create()->setPath($storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_WEB).'mestremage/pdf?param=fechar_plp&order_ids='.$orederId.'&_='.time());
    }
