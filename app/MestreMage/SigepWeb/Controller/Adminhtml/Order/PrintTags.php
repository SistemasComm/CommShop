...
class PrintTags extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction {
	...
	protected function massAction( AbstractCollection $collection )
	{
		...
		return $this->resultRedirectFactory->create()->setPath($storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_WEB).'mestremage/pdf?param=imprimirEtiquetas_2018&order_ids='.$orederId.'&_='.time());
