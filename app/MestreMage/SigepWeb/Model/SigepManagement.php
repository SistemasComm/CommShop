...
namespace MestreMage\SigepWeb\Model;
...
class SigepManagement implements \MestreMage\SigepWeb\Api\SigepManagementInterface
{
        ...
        switch ($param) {
            ...
            case 'imprimirEtiquetas_2018':
                ...
                $encomendas = [];
                    ...
                    if (count($encomendas)) {
                        ...
                        $remetente->setCep(preg_replace("/[^0-9]/", "", $this->getConfig('section_module_sigepweb/sigepweb/cep_origem')));
                        ...
                        $this->setLog('imprimirEtiquetas: '.json_encode($plp));
            ...
            case 'print_plp':
                ...
                if (count($encomendas)) {
                    ...
                    $this->setLog('print_plp: '.json_encode($plp));
                    ...
                    foreach ($order_ids as $key => $order_id) {
                        ...
                        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
                         ...
                         if($order->getPayment()->getAdditionalInformation('sigep_etiquetas_sem_dv')){
                            ...
                            <cep_remetente><![CDATA[".preg_replace("/[^0-9]/", "", $this->getConfig('section_module_sigepweb/sigepweb/cep_origem'))."]]></cep_remetente>
                            ...
                            $soapArgs = array(
                                ...
                                $this->setLog('ENVIO :: fechar_plp: '.json_encode($soapArgs));

                            $returnPlp = $client->fechaPlpVariosServicos( $soapArgs ); 
                             
                             $this->setLog('RETORNO :: fechar_plp: '.json_encode($returnPlp));
